...
<div class="right_col canchinh" role="main">
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Quản lý chương trình <small>Thêm chương trình</small></h2>
                    ...
                    <form role="form" action="{{ URL::to('save-chitietkhoahoc') }}" method="post" class="form-horizontal form-label-left">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <input type="text" id="curriculums_title" name="curriculums_title" required="required" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <textarea style="resize: none" rows="5" class="form-control" name="curriculums_content"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            <div class="col-md-6 col-sm-6 offset-md-3">
                                <button class="btn btn-primary" type="submit" name="add_chitietkhoahoc">Thêm chương trình</button>
