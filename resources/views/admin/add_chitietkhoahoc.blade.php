...
<div class="right_col canchinh" role="main">
	...
	<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Quản lý chương trinh<small>Thêm chương trình</small></h2>
                                ...
                                @endif
									...
									<form role="form" action="{{ URL::to('save-chitietkhoahoc') }}" method="post" data-parsley-validate class="form-horizontal form-label-left">
    @csrf
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												<button class="btn btn-primary" type="summit" name="add_chitietkhoahoc">Thêm chi tiết currilum</button>
