...
<div class="right_col canchinh" role="main">
	...
	<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Quản lý reviews<small>thêm reviews</small></h2>
                                ...
                                @endif
									...
									<form role="form" action="{{ URL::to('save-reviews') }}" method="post" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
    @csrf
