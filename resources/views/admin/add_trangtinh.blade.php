						...
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
                                ...
                                @endif
									...
									<form role="form" action="{{ URL::to('save-page') }}" method="post" data-parsley-validate class="form-horizontal form-label-left">
    @csrf
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="last-name" name="page_title" required="required" class="form-control">
											</div>
										</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea style="resize: none" rows="5"  class="form-control" type="longtext" name="student_note"></textarea>
											</div>
										</div>
										<div class="item form-group">
