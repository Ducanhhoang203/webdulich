						...
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
                                ...
                                @endif
									...
									<form role="form" action="{{ URL::to('update-faqct/'.$edit_value->id) }}" method="post" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
    @csrf
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												<button class="btn btn-primary" type="summit" name="edit_faqct">Cập nhật</button>
