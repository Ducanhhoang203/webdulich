...
<div class="right_col canchinh" role="main">
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Quản lý Reviews <small>Chỉnh sửa Review</small></h2>
                ...
                <div class="x_content">
                    ...
                    <form action="{{ URL::to('update-reviews/'.$edit_value->reviews_id) }}" method="post" class="form-horizontal form-label-left">
                        @csrf
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <input type="text" name="review_name" class="form-control" required
                                    value="{{ old('review_name', $edit_value->review_name) }}">
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <input type="number" name="review_star" class="form-control" min="1" max="5" required
                                    value="{{ old('review_star', $edit_value->review_star) }}">
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <textarea name="reviews_content" rows="5" class="form-control">{{ old('reviews_content', $edit_value->reviews_content) }}</textarea>
                            </div>
                        </div>
                                ...
                                <select name="product_id" class="form-control">
                                    @foreach ($product as $pro)
                                        <option value="{{ $pro->product_id }}"
                                            {{ $pro->product_id == $edit_value->product_id ? 'selected' : '' }}>
                                            {{ $pro->product_name }}
                                        </option>
                                    @endforeach
                                </select>
