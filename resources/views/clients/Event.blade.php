                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="section-title text-center counter-text-wrap mb-50" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                            <h2>Events 3</h2>
                            <p>One site <span class="count-text plus" data-speed="3000" data-stop="3500">0</span> Events</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-sm-6">
                        <div class="gallery-two-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <div class="content">
                                <span class="category">Spicy Quince And Cranberry Chutney</span>
                                <h5><a href="destination-details.html"> New Margania</a></h5>
                            </div>
                        </div>
                    </div>
                  <div class="col-lg-4 col-sm-6">
