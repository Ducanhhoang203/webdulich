                            ...
                            <div class="widget widget-activity" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                                ...
                                <ul class="categoryname">
                                    <li>
                                       ...
                                       <a href="{{ URL::to('/danh-muc-san-pham/' . $cate->catgory_id) }}">{{ $cate->catgory_name }}</a>
                                    </li>
                        ...
                        @foreach ($category_by_id as $key => $pro)
                            ...
                            <div class="content">
                                ...
                                <div class="destination-footer">
                                    ...
                                    <a href="{{ URL::to('/chi-tiet-san-pham/' . $pro->product_id) }}"class="theme-btn style-two style-three"> 
